...
import com.hzxm.wolaixish.MainApp;
import com.hzxm.wolaixish.R;
import com.hzxm.wolaixish.base.adapter.BaseAdapter;
import com.hzxm.wolaixish.base.util.GlideCircleTransform;
import com.hzxm.wolaixish.base.util.StatueBarUtil;
import com.hzxm.wolaixish.base.view.RecycleViewHeadView;
...
public class BaseActivity<T> extends FragmentActivity implements FragmentPermissionListener ,PermissionListener{
    ...
    protected void setRightAndTitleText(String rightText,String titleText){
        View back=findViewById(R.id.back);
        if (back!=null)
            back.setOnClickListener(v -> onBackPressed());
       TextView righText=findViewById(R.id.right_text);
        righText.setVisibility(View.VISIBLE);
        if (righText!=null)
            righText.setText(rightText);
        TextView title=findViewById(R.id.title_name);
        if (title!=null)
...
//                goToAnimation(1);
    ...
    protected void disPlayRoundImage(ImageView imageView,String url) {
        ...
        Glide.with(appContext).load(url).transform(new GlideCircleTransform(appContext))
//                .placeholder(R.drawable.user_default_icon)
    ...
    protected void setRecycleView(BaseAdapter adapter, LRecyclerView recycleView) {
        ...
        recycleView.setLayoutManager(new LinearLayoutManager(appContext));
